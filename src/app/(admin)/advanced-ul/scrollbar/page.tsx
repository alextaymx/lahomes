    ...
    >
      <div className="border rounded py-3">
        <SimplebarReactClient className="px-3" style={{ maxHeight: 250 }}>
          ...
          without losing performances. Unlike some popular plugins, SimpleBar doesn&apos;t mimic scroll with Javascript,
          causing janks and strange scrolling behaviours... You keep the awesomeness of native scrolling...with a custom
          scrollbar!
          <p>
            SimpleBar&nbsp;
          ...
          <p>
            SimpleBar uses pure CSS to style the scrollbar. You can easily customize it as you want! Or even have
            multiple style on the same page...or just keep the default style (&quot;Mac OS&quot; scrollbar style).
          </p>
...
const RTLPosition = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Just use data attribute&nbsp;<code>data-simplebar data-simplebar-direction=&apos;rtl&apos;</code> and add{" "}
  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          {" "}
          Just use data attribute <code>data-simplebar</code>, <code>data-simplebar-lg</code> and add{" "}
          <code>max-height: **px</code> oh fix height
        </>
      }
    >
...
const ScrollColor = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Just use data attribute <code>data-simplebar data-simplebar-*</code> and add <code>max-height: **px</code> oh
          fix height
        </>
      }
    >
