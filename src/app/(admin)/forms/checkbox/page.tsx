  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          {" "}
          Each checkbox and radio <code>&lt;input&gt;</code> and <code>&lt;label&gt;</code> pairing is wrapped in a{" "}
          <code>&lt;div&gt;</code> to create our custom control. Structurally, this is the same approach as our default{" "}
...
const DefaultRadio = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Each Radio <code>&lt;input&gt;</code> and <code>&lt;label&gt;</code> pairing is wrapped in a{" "}
          <code>&lt;div&gt;</code> to create our custom control. Structurally,this is the same approach as our default{" "}
          <code>.form-check</code>.
        </>
      }
...
const Switches = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          A switch has the markup of a custom checkbox but uses the <code>.form-switch</code> class to render a toggle
          switch. Switches alsosupport the <code>disabled</code> attribute.
        </>
      }
    >
