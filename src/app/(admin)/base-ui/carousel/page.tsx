...
const SlidesOnly = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Here’s a carousel with slides only. Note the presence of the <code>.d-block</code> and <code>.img-fluid</code>{" "}
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          display utilities. We hide them initially with <code>.d-none</code> and bring them back on medium-sized
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          Depending on your carousel content (e.g., text only slides), you may want to add <code>.bg-body</code> or some
          custom CSS to the <code>.carousel-item</code>s for proper crossfading.
        </>
      }
    >
      {/* <Row> */}
...
const IndividualInterval = () => {
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Add <code>data-bs-interval=&ldquo;</code> to a <code>.carousel-item</code> to change the amount of time to
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          the <code>data-bs-touch</code> attribute. The example below also does not includethe <code>data-bs-ride</code>{" "}
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          Controls have been inverted from their default white fill with the<code>filter</code> CSS property. Captions
          and controls have additional Sass variables that customize the<code>color</code> and{" "}
