...
const DefaultModal = () => {
  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          Toggle a working modal demo by clicking the button below. It will slide down and fade in from the top of the
          page.
        </>
      }
    >
  ...
  return (
    <ComponentContainerCard
      ...
      description={
        <>
          {" "}
          When modals become too long for the user’s viewport or device, they scroll independent of the page itself. Try
        ...
        <Modal show={isModelOpenOne} className="fade" id="exampleModalLong" tabIndex={-1}>
          ...
          <ModalBody style={{ minHeight: 1500 }}>
            <p>
              ...
              the modal, we use an inline style set a minimum height, thereby extending the length of the overall modal
      ...
      <div className="mb-3">
        <div className="d-flex flex-wrap gap-2">
          ...
          <Modal show={isOpenScrollableModel} onHide={toggleScrollableModel} className="fade" scrollable centered>
            ...
            <ModalBody>
              <p>
                This is some placeholder content to show a vertically centered Modal We&apos;ve added some extra copy
                here to show how vertically centering the modal works when combined with scrollable modals. We also use
                some repeated line breaks to quickly extend the height of the content, thereby triggering the scrolling.
    ...
    <ComponentContainerCard
      ...
      description={
        <>
          ...
          <code>data-bs-toggle</code> attributes. For example, you could toggle a password reset modal from within an
          already open sign in Modal <strong>Please note multiple modals cannot be open at the same time</strong>—this
